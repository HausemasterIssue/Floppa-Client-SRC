...
public class Checkbox extends PartTemplate {
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.name, (float) ((this.parent.parent.getX() + 10 + 4) * 2 + 5), (float) ((this.parent.parent.getY() + this.offset + 2) * 2 + 4), -1);
        GL11.glPopMatrix();
